...
## Western University's Dates

This project relies on Western's sessional dates, which are not fully deterministic. They are posted for the current school year here: https://www.westerncalendar.uwo.ca/SessionalDates.cfm?CategoriesFilter=5&TypesFilter=1&searchWithBoxes=&SelectedCalendar=Live&ArchiveID=

Later down the line, the process of updating these dates should be automated somehow.
